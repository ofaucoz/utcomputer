#include "numeric_lesser_equals.h"

void NumericLesserEqualsOperator::apply(LiteralsStack &stack) const {
    if (stack.size() < 2) {
        throw InvalidSyntaxException("Lesser or equals operator requires 2 operands");
    }
